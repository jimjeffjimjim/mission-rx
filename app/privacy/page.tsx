    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans pb-20 selection:bg-teal-600 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 mt-8 space-y-8">
        ...
        <div className="text-center pt-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-xs font-black text-teal-700 hover:text-teal-800 bg-white border border-teal-200 px-5 py-3 rounded-2xl shadow-xs hover:shadow-md transition-all"
          >
            <ArrowLeft className="w-4 h-4 stroke-[2.5]" />
