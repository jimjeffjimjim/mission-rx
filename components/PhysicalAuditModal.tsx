...
export default function PhysicalAuditModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-xs p-3 sm:p-4 overflow-y-auto">
      <div className="bg-white border-2 border-amber-500 rounded-3xl p-5 sm:p-7 max-w-6xl w-full shadow-2xl space-y-5 text-slate-900 my-6 max-h-[94vh] flex flex-col justify-between">
        {/* Header Bar */}
        ...
        <div className="overflow-x-auto rounded-2xl border border-slate-200 shadow-2xs flex-1 max-h-[50vh]">
          <table className="w-full text-left border-collapse bg-white">
            <thead className="sticky top-0 z-10 bg-slate-100 text-slate-700 text-xs font-black uppercase tracking-wider border-b border-slate-200">
              <tr>
                <th className="py-3 px-3.5">Shelf / Location</th>
                <th className="py-3 px-3.5">Formulation / Item</th>
                <th className="py-3 px-3.5 text-center">System Expected</th>
                <th className="py-3 px-3.5 text-center bg-amber-50/70 border-x border-amber-200">
                  Actual Physical Count
                </th>
                <th className="py-3 px-3.5 text-center">Variance</th>
                <th className="py-3 px-3.5">Discrepancy Reason / Note</th>
              </tr>
            </thead>
                ...
                filteredItems.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-2.5 px-3.5">
                        ...
                        <div className="text-[11px] text-slate-500 font-semibold flex items-center gap-1.5">
                          ...
                          {item.pillsPerBottle && item.pillsPerBottle > 1 && (
                            <>
                              <span>•</span>
                              <span>Pack of {item.pillsPerBottle}</span>
                            </>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="py-2 px-3 bg-amber-50/50 border-x border-amber-200">
